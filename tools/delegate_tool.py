...
def _build_child_system_prompt(
    ...
    *,
    ...
    parts.append(
        ...
        "Delegated terminal safety: Inline interpreter payloads such as python -c, node -e, and interpreter heredocs are denied. "
        "Do not retry a rejected payload in another inline form. For multiline logic, create a scratch script with write_file and execute it by absolute path; "
        "prefer read_file and search_files for direct inspection.\n\n"
